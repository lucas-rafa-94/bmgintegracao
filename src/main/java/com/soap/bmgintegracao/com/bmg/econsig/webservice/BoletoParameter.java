...
public class BoletoParameter  extends com.soap.bmgintegracao.com.bmg.econsig.webservice.AbstractWebServicesParameter  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservice.econsig.bmg.com", "BoletoParameter"));
